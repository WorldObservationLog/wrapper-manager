...
const (
	...
	WrapperManagerService_Tokens_FullMethodName      = "/manager.v1.WrapperManagerService/Tokens"
)
...
type WrapperManagerServiceClient interface {
	...
	Tokens(ctx context.Context, in *TokensRequest, opts ...grpc.CallOption) (*TokensReply, error)
}
...
func (c *wrapperManagerServiceClient) Tokens(ctx context.Context, in *TokensRequest, opts ...grpc.CallOption) (*TokensReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TokensReply)
	err := c.cc.Invoke(ctx, WrapperManagerService_Tokens_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WrapperManagerServiceServer interface {
	...
	Tokens(context.Context, *TokensRequest) (*TokensReply, error)
...
func (UnimplementedWrapperManagerServiceServer) Tokens(context.Context, *TokensRequest) (*TokensReply, error) {
...
func _WrapperManagerService_Tokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TokensRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WrapperManagerServiceServer).Tokens(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WrapperManagerService_Tokens_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WrapperManagerServiceServer).Tokens(ctx, req.(*TokensRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var WrapperManagerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Tokens",
			Handler:    _WrapperManagerService_Tokens_Handler,
		},
	},
